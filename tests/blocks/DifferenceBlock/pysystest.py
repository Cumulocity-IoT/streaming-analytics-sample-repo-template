...
__pysys_title__   = r""" Difference block: To check the basic working of the block"""
__pysys_purpose__ = r""" To check that the blocks is able calculate the difference between the two inputs correctly. """
...
class PySysTest(AnalyticsBuilderBaseTest):
	def execute(self):
		...
		self.modelId = self.createTestModel('apamax.analyticsbuilder.samples.Difference')
